...
$catalogodehom=  mysqli_query($conec,"SELECT * FROM cata WHERE tipo='Ns' ");
while ($busqueda= mysqli_fetch_array($catalogodehom)) {
...
";
  ...
  echo "
            ...
            <div class='card-image '>
              ...
              <form  action='vista/compraninios.php' method='post'>
