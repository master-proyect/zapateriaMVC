...
if ($talla == 24 ||$talla == 24.5||$talla == 25 ||$talla == 25.5||$talla == 26 ||$talla == 26.5||$talla == 27 ||$talla == 27.5||$talla == 28 ||$talla == 28.5||$talla == 29 ||$talla == 29.5||$talla == 30||$talla == 30.5||$talla == 31) {

  $talla=  mysqli_query($conec,"SELECT * FROM cata WHERE tipo='Ho' AND talla ='$talla'");
...
if ($valor == "on") {
  $preciobajo=  mysqli_query($conec,"SELECT * FROM cata WHERE tipo='Ho' order by precio");
  ...
  {
    $catalogodehombres=  mysqli_query($conec,"SELECT * FROM cata WHERE tipo='Ho' order by precio desc ");
