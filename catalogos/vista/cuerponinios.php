...
<div class="collapsible-body grey lighten-5 ">
  <form action="#">
     <p class="range-field black-text "  >
       <input   onchange="talla()" type="range" id="test5" min="13" max="23.5" step="0.5"/>
     </p>
   </form>
</div>
...
<a href="http://127.0.0.1/zapateriaMVC/index.php"><i class="fa fa-home" aria-hidden="true"> Inicio </i>
  ...
  <div class="chip">
    <a href="ninios.php"><i class="fa fa-male" aria-hidden="true"> Niños</i>
</a>
  </div>
<br>
