...
<div class="collapsible-body grey lighten-5 ">
  <form action="#">
     <p class="range-field black-text "  >
       <input   onchange="talla()" type="range" id="test5" min="22" max="27" step="0.5"/>
     </p>
   </form>
</div>
...
<div class="collapsible-body grey lighten-5">
  ...
  <p>
    ...
    <label for="cater">Andrea</label>
  </p>
  <p>
    <input onclick="c()" onchange="showContent2()"  type="checkbox" id="con"   class="filled-in" />
    <label for="con">Dr Scholl's </label>
  </p>
  <p>
...
<a href="http://127.0.0.1/zapateriaMVC/index.php"><i class="fa fa-home" aria-hidden="true"> Inicio </i>
  ...
  <div class="chip">
    <a href="mujer.php"><i class="fa fa-male" aria-hidden="true"> Mujer</i>
</a>
  </div>
<br>
